/* eslint-disable */
// Runtime types generated with workerd@1.20260617.1 2026-04-21 enable_request_signal,no_nodejs_compat_v2,nodejs_compat,request_signal_passthrough
// Begin runtime types
/*! *****************************************************************************
...
interface SendEmail {
	...
	send(builder: { from: string | EmailAddress; to: string | EmailAddress | (string | EmailAddress)[]; subject: string; replyTo?: string | EmailAddress; cc?: string | EmailAddress | (string | EmailAddress)[]; bcc?: string | EmailAddress | (string | EmailAddress)[]; headers?: Record<string, string>; text?: string; html?: string; attachments?: EmailAttachment[] }): Promise<EmailSendResult>;
}
