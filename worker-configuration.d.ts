/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a10db8b1efaee128ce0ebc2bcb83609c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'DUMMY_SECRET'>> {}
}
